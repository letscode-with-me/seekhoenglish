...
import { ChevronDown, Mail, TextAlignJustify } from 'lucide-react';
export default function Header() {
    return (
        <header className='flex justify-between w-full md:max-w-[80%] md:mx-auto h-18  px-5 items-center  font-bold sm:'>
            <div>
